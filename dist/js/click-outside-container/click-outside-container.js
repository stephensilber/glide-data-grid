...
var _excluded = ["onClickOutside", "stopPropagation"];
...
var ClickOutsideContainer = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(ClickOutsideContainer, _React$PureComponent);

  var _super = _createSuper(ClickOutsideContainer);

  function ClickOutsideContainer() {
    var _this;

    _classCallCheck(this, ClickOutsideContainer);
    ...
    _defineProperty(_assertThisInitialized(_this), "clickOutside", function (event) {
      if (_this.wrapperRef.current !== null && !_this.wrapperRef.current.contains(event.target)) {
        ...
        if (_this.props.stopPropagation === true) {
  ...
  _createClass(ClickOutsideContainer, [{
